<template>
  ...
  <div id="content" class="container-fluid px-5">
    <h3 class="text-center" style="margin-top: 120px; margin-bottom: 60px;">QUẢN LÝ NGƯỜI DÙNG CỦA CỬA KHẨU</h3>
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-sm-6">
            ...
            <select class="form-control form-select h-auto wide" v-model="searchVaiTro">
              <option></option>
              <option v-for="vaiTro in vaiTros.filter(vaiTro => [2, 4].includes(vaiTro.ma_vai_tro))" :key="vaiTro.ma_vai_tro" :value="vaiTro.ma_vai_tro">
                {{ vaiTro.ten_vai_tro }}
              </option>
            </select>
          </div>
